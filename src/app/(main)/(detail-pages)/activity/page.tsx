      ...
      <div className='p-8 bg-white'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
            {/* 알고리즘 스터디 */}
            <div className='bg-gray-light rounded-lg p-6 hover:shadow-md transition-shadow'>
            ...
            {/* 프로젝트 개발 */}
            <div className='bg-gray-light rounded-lg p-6 hover:shadow-md transition-shadow'>
              <div className='w-12 h-12 bg-brand-green-primary rounded-full flex items-center justify-center mb-4'>
                <span className='text-white text-xl'>💻</span>
              </div>
              <h3 className='text-lg font-bold text-text-primary mb-2'>
                프로젝트 개발
          ...
          <div>
            ...
            <div className='space-y-4'>
              <div className='border-l-4 border-brand-blue bg-gray-muted p-4 rounded-r-lg'>
                <div className='flex justify-between items-start mb-2'>
                  <h4 className='font-bold text-text-primary'>
                    정기 알고리즘 스터디
                  </h4>
                  <span className='text-sm text-text-secondary'>2024.01</span>
                </div>
                <p className='text-text-secondary text-sm'>
              ...
              <div className='border-l-4 border-brand-green-primary bg-gray-muted p-4 rounded-r-lg'>
                <div className='flex justify-between items-start mb-2'>
                  <h4 className='font-bold text-text-primary'>
                    웹 개발 프로젝트
                  </h4>
                  <span className='text-sm text-text-secondary'>2023.12</span>
                </div>
                <p className='text-text-secondary text-sm'>
              ...
              <div className='border-l-4 border-brand-orange bg-gray-muted p-4 rounded-r-lg'>
                <div className='flex justify-between items-start mb-2'>
                  <h4 className='font-bold text-text-primary'>
                    ICPC 대회 참가
                  </h4>
                  <span className='text-sm text-text-secondary'>2023.11</span>
                </div>
                <p className='text-text-secondary text-sm'>
